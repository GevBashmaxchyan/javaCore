...
public class PracticeHomeworkTest {
    public static void main(String[] args) {
        ...
        System.out.println("վերադարձնել true եթե տրված a և b թվերը իրար հավասար են, եթե ոչ՝ false: " + ph.isSameNum(7, 5));
        System.out.println("վերադարձնել true-եթե թիվը փոքր կամ հավասար է 0-ին մնացած դեպքերում  false: "+ph.lessThanOrEqualToZero(-2));
        System.out.println("վերադարձնել ընդունող բուլյանի ժխտված արժեքը։ "+ph.reverseBool(false));
